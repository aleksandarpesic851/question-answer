                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="row " style=" min-height: 100%; align-items: center;">
                      <img class="avatar-image" id="avatar_image" src="{{ old('avatar', $user->avatar) }}">
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-8 col-sm-9 col-md-7">
                        <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}"  data-toggle="tooltip" title="{{ __('messages.email_tooltip') }}">
                          <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="input-email" type="email" placeholder="{{ __('messages.email') }}"  value="{{ old('email', $user->email) }}" required aria-required="true" />
                          @if ($errors->has('email'))
